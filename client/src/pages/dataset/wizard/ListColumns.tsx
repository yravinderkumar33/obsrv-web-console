            ...
            <GenericCard elevation={1}>
                ...
                <Stack direction="row" spacing={1} marginBottom={1} alignItems="center" justifyContent="space-between">
                    <Box display="flex" justifyContent="space-evenly" alignItems="center">
                        ...
                        {filterByChip &&
                            <Button data-edataid={`${master ? 'masterDataset': 'dataset'}:list:columns`} data-objectid="closeOutlined:clearFilter" data-objecttype={master ? 'masterDataset': 'dataset'}  size="medium" onClick={deleteFilter} startIcon={<CloseOutlined />} sx={{ fontWeight: 500 }}>
                                Clear filters
                            </Button>
                        }
                    </Box>
