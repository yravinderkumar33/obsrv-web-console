...
const Theme7 = (colors: PalettesProps, mode: ThemeMode): PaletteThemeProps => {
    ...
    let primaryColors = ['#36539a6e', '#8cdba9', '#63cf8e', '#3ec277', '#1db564', '#00a854', '#008245', '#005c34', '#003620', '#000f0a'];
    let errorColors = ['#FDE8E7', '#F25E52', '#F04134', '#EE3B2F', '#E92A21'];
    let warningColors = ['#FFF7E0', '#FFC926', '#FFBF00', '#FFB900', '#FFA900'];
    let infoColors = ['#E0F4F5', '#26B0BA', '#36539A', '#009AA7', '#008694'];
    ...
    if (mode === 'dark') {
        ...
        infoColors = ['#1a2628', '#11595f', '#36539A', '#1ea6aa', '#64cfcb'];
